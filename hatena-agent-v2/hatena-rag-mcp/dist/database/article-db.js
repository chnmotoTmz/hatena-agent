    ...
    `);
        try {
            ...
            for (const article of articles) {
                // Save article
                await insertArticle.run(article.id, article.title, article.url, article.date, JSON.stringify(article.categories), article.summary, article.content || '', article.wordCount);
